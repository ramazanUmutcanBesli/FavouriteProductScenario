Feature: N11 Favourite Product
  ...
  Scenario: Add Favourite Product
    Given user see home page of N11 website
    Then verify that user should see home page of N11 website
    When user log in with user credentials
    And verify that user should log in with user credentials
    ...
    And user put 3 rd product in favourite
    ...
    And user delete favourite product from page
